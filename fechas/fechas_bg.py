...
ARCHIVO_SALIDA = "Fechas_BG_Estandarizadas.xlsx"
INDICE_COLUMNA_FECHA = 58  # Columna BG es la número 59, índice 58
...
def estandarizar_formato_fecha_bg(
    ...
    print(
        f"Corrigiendo la Columna BG (índice {nombre_columna_fecha}) de números de serie a fechas..."
    )
