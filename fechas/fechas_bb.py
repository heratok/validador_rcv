...
ARCHIVO_SALIDA = "Fechas_BB_Estandarizadas.xlsx"
INDICE_COLUMNA_FECHA = 53  # Columna BB es la número 54, índice 53
...
def estandarizar_formato_fecha_bb(
    ...
    print(
        f"Corrigiendo la Columna BB (índice {nombre_columna_fecha}) de números de serie a fechas..."
    )
