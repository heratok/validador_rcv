...
ARCHIVO_SALIDA = "Fechas_BH_Estandarizadas.xlsx"
INDICE_COLUMNA_FECHA = 59  # Columna BH es la número 60, índice 59
...
def estandarizar_formato_fecha_bh(
    ...
    print(
        f"Corrigiendo la Columna BH (índice {nombre_columna_fecha}) de números de serie a fechas..."
    )
