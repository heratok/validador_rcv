...
ARCHIVO_SALIDA = "Fechas_AX_Estandarizadas.xlsx"
INDICE_COLUMNA_FECHA = 49  # Columna AX es la número 50, índice 49
...
def estandarizar_formato_fecha_ax(
    ...
    print(
        f"Corrigiendo la Columna AX (índice {nombre_columna_fecha}) de números de serie a fechas..."
    )
