...
ARCHIVO_SALIDA = "Fechas_AD_Estandarizadas.xlsx"
INDICE_COLUMNA_FECHA = 29  # Columna AD es la número 30, índice 29 en Python
...
def estandarizar_formato_fecha_ad(
    ...
    print(
        f"Corrigiendo la Columna AD (índice {nombre_columna_fecha}) de números de serie a fechas..."
    )
