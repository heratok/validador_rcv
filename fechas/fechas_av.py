...
ARCHIVO_SALIDA = "Fechas_AV_Estandarizadas.xlsx"
INDICE_COLUMNA_FECHA = 47  # Columna AV es la número 48, índice 47
...
def estandarizar_formato_fecha_av(
    ...
    print(
        f"Corrigiendo la Columna AV (índice {nombre_columna_fecha}) de números de serie a fechas..."
    )
